...
/**
 * Helper class containing methods to gather user information and buyer requirements for house purchasing.
 */
public class applicationHelper {

    /**
     * Gathers user information regarding annual income and generates maximum loan amount.
     */
